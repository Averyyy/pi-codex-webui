export type ScheduledPromptMode = "subagent_start" | "subagent_done" | "subagent_error"
...
export function isScheduledPromptViewState(value: unknown): value is ScheduledPromptViewState {
  ...
  if (value.mode !== "subagent_start" && value.mode !== "subagent_done" && value.mode !== "subagent_error") return false
  if (value.output !== undefined && typeof value.output !== "string") return false
  if (value.error !== undefined && typeof value.error !== "string") return false
  return true
}

export function extractScheduledPromptState(details: unknown): ScheduledPromptViewState | undefined {
  if (!isRecord(details)) return undefined
  if (typeof details.jobName !== "string") return undefined
  const mode = details.mode
  if (mode !== "subagent_start" && mode !== "subagent_done" && mode !== "subagent_error") return undefined
